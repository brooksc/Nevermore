...
///
/// Watch live:
///   log stream --predicate 'subsystem == "com.brooksc.mailscrub"' --level debug
/// Read recent history:
///   log show --predicate 'subsystem == "com.brooksc.mailscrub"' --last 1h --info --debug
///
...
public enum Log {
    public static let subsystem = "com.brooksc.mailscrub"
