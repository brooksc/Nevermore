...
**Status:** versioning, DMG packaging, and the Sparkle wiring are implemented.
What remains is generating the Sparkle signing key, publishing an appcast, and
the store submission itself.
